...
public class srcML_TreeOfSoftware_ProjectsLevEncoding : _IEncodingGenerator<string>
{
    private readonly _IEncodingGenerator<string> singleProjectFilesIEncoding;
    ...
    public srcML_TreeOfSoftware_ProjectsLevEncoding(_IEncodingGenerator<string> singleProjectFilesIEncoding) : base()
    {
    ...
    protected override bool GenerateGene(in string folderPath, out Gene<string> gene)
    {
        ProcessFilesInFolder(folderPath, out gene);
        return false;
    }

    public override void GenerateEncoding(in string[] files, ref DataStructures.Gene<string>[] genes,
        bool processInParallel = false)
    {
        genes = new DataStructures.Gene<string>[files.Length];
    ...
    private void ProcessFilesInFolder(in string folderPath, out DataStructures.Gene<string> gene)
    {
        DataStructures.Gene<string>[] projectGenes = Array.Empty<DataStructures.Gene<string>>();
